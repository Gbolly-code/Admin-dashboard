...
import { BarChart as RechartsBarChart, Bar, CartesianGrid, Legend, ResponsiveContainer, Tooltip, XAxis, YAxis } from 'recharts';
...
const ProductPerformanceChart = () => {
  ...
  return (
    <motion.div className='bg-[#1e1e1e] backdrop-blur-lg shadow-lg rounded-xl p-4 md:p-6 border-[#1f1f1f]
    mx-2 md:mx-0' initial={{ opacity: 0, y: 20 }}
