...
const Header = () => {
  ...
  return (
    <header className='fixed top-0 left-0 right-0 z-50 bg-[#1e1e1e]/80 backdrop-blur-md shadow-lg border-b border-[#1f1f1f] mx-4 sm:mx-6 lg:mx-8 mt-4 mb-2 rounded-lg'>
